...
export default class AppIntroSlider extends React.Component {
    ...
    _renderItem = (item) => {
        ...
        return this.props.renderItem ? this.props.renderItem(props, this) : <DefaultSlide {...props} />;
    }
    ...
    _renderDefaultButton = (name) => {
        ...
        if (this.props.bottomButton) {
            content = <View style={[styles.bottomButton, (name === 'Skip' || name === 'Prev') && { backgroundColor: 'transparent' },
                this.props.buttonStyle]}>{content}</View>
        }
        return content;
    }
    ...
    _renderDoneButton = () => { return  (this.state.checked && this.state.policyChecked) ?
    ...
    _renderAccpetTerms = () => {
        ...
        return  isLastSlide ? <View style={styles.termsContainer}>
                    <CheckBox
                        containerStyle={{backgroundColor: 'transparent', borderWidth: 0}}
                        title="You accept the terms and condition, link to it"
                    ...
                    <CheckBox
                        containerStyle={{backgroundColor: 'transparent', borderWidth: 0}}
                        title="You confirm you have read the privacy policy, link to it"
        ...
        return (
            <View style={styles.flexOne}>
                <FlatList
                    ...
                    {...otherProps}
                    onScrollBeginDrag={() => this.setState({dragging: false})}
                    onScrollEndDrag={() => this.setState({dragging: true})}
                />
